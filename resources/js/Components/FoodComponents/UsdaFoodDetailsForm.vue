  ...
  <form @submit.prevent="createFoodItem" action="" class="p-6 space-y-3">
    ...
    <div class="flex  ">
      <div class="basis-3/5 me-3">
        ...
        <TextInput id="description" v-model="form.description" :class="loadingClasses" class="w-full" ref="nameInput"
          required>
        </TextInput>
      ...
      <div class="basis-2/5">
        ...
        <TextInput id="category" v-model="form.foodCategory" :class="loadingClasses" class="w-full" required>
        </TextInput>
    ...
    <div class="flex  items-center">
      ...
      <div class="basis-3/5 me-3">
        ...
        <div id="calories" :class="loadingClasses" class="rounded px-2 py-1 mt-2">
      ...
      <div class="flex basis-2/5">
        <div class="w-full relative">
          ...
          <div v-else>
            ...
            <NumberInput id="servingSize" v-model="form.portionModifier" :class="loadingClasses" class="w-full"
    ...
    <div>
      ...
      <div class="flex ">
        <div class="basis-1/2 me-3">
          ...
          <TextInput id="brandName" v-model="form.brandName" :class="loadingClasses" class="w-full"></TextInput>
        ...
        <div class="basis-1/2">
          ...
          <TextInput id="brandOwner" v-model="form.brandOwner" :class="loadingClasses" class="w-full"></TextInput>
