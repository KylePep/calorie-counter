...
<template>
  ...
  <div class=" group flex justify-end items-center h-full">
    ...
    <button
      class="group min-w-8 relative flex items-center justify-end text-xl bg-accent text-dark rounded-xl group-hover:bg-neutral ps-2 transition ease-in-out duration-300">
      <span
