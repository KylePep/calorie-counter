...
<template>
  ...
  <div
    class="grid grid-cols-1 sm:grid-cols-2 min-[1600px]:grid-cols-3 gap-2 bg-gradient-to-b from-light via-main to-main p-2 text-center border-2 rounded border-neutral">
