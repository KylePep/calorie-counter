...
<template>
  ...
  <button @click="setActive(foodItem)" :style="{ backgroundImage: 'url(' + foodItem.photo + ')' }"
    ...
    <div :class="foodItem.photo ? 'bg-dark/50' : 'bg-light'"
      class="h-full w-full flex flex-col justify-center items-center  group-hover:bg-dark/90 rounded-sm px-1 sm:px-2 py-2 sm:py-4 duration-300">
