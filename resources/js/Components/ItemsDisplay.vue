...
<template>
  ...
  <div
    class="grid grid-flow-col gap-3 min-h-40 p-2 text-center bg-gradient-to-b from-gray-200 via-white  border-2 rounded-lg border-black/25 overflow-x-auto whitespace-nowrap shadow-inner "
